...
public class Sim {
    ...
    public static void main(String[] args) {
        ...
        if(start_persent_black + start_persent_whites + start_persent_yellows > 100 || albedo_of_whites >0.99 || albedo_of_blacks > 0.99 || solar_luminosity > 3 || albedo_of_surface > 1){
            System.out.println("invalid input detected.");
        }else{
            Ground ground = new Ground(30, solar_luminosity, start_persent_whites, start_persent_black, start_persent_yellows, albedo_of_blacks, albedo_of_whites, scenario, albedo_of_surface, end_year);
            ground.run();
        }
